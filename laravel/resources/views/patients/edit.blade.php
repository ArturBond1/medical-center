    ...
    <form action="{{ route('patients.update', $patient->id) }}" method="POST" class="needs-validation" novalidate>
        ...
        <div class="form-group">
            ...
            <select class="form-control @error('gender') is-invalid @enderror" id="gender" name="gender">
                ...
                <option value="other" {{ $patient->gender == 'other' ? 'selected' : '' }}>Інше</option>
            </select>
            @error('gender')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('address') is-invalid @enderror" id="address" name="address" value="{{ $patient->address }}">
